...
#[component]
pub fn LogoPage() -> impl IntoView {
    view! {
        <main class="my-0 w-full text-center flex flex-col justify-around bg-zinc-900">
            <Logo />
        </main>
    }
}
...
pub fn Logo() -> impl IntoView {
    view! {
        <div class="relative isolate flex flex-col items-center leading-none select-none py-4 xl:py-6">
            ...
            <div class="pointer-events-none absolute left-1/2 top-1/2 h-[12rem] w-[12rem] xl:h-[17rem] xl:w-[17rem] -translate-x-1/2 -translate-y-1/2
