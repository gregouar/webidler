...
use shared::{
    ...
    http::{
        ...
        server::{
            ...
            GetBenedictionsResponse, RejectMarketItemResponse, SellMarketItemResponse,
        },
    },
};
...
pub fn routes(app_state: AppState) -> Router<AppState> {
    ...
    Router::new()
        .route("/benedictions", get(get_benedictions))
        .merge(auth_routes)
}
...
pub async fn get_benedictions(
    ...
    Ok(Json(GetBenedictionsResponse {
        benedictions_specs: master_store.benedictions_store.clone(),
    }))
}
