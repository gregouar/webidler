...
use shared::{constants::THREAT_EFFECT, data::item::ItemSpecs};

use crate::components::{
    shared::tooltips::ItemTooltip,
    ui::tooltip::{
...
#[component]
pub fn AutoUseIcon() -> impl IntoView {
    view! {
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
...
#[component]
pub fn AreaLevelIcon() -> impl IntoView {
    view! {
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
