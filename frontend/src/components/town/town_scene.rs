...
pub fn TownScene() -> impl IntoView {
    ...
    view! {
        <div class="w-full grid grid-cols-3 gap-2 lg:gap-4 p-2 lg:p-4 ">
            ...
            <div class="w-full col-span-2 justify-self-start">
                ...
                gap-1 lg:gap-2 p-1 lg:p-2 
                shadow-lg relative flex flex-col">

                    <div class="px-2 lg:px-4 relative z-10 flex items-center justify-between gap-1 lg:gap-2 flex-wrap">
                        <span class="text-shadow-md shadow-gray-950 text-amber-200 text-lg lg:text-xl font-semibold">
                            "Choose your grind"
                        </span>
                    </div>

                    <div class="grid grid-cols-3 lg:grid-cols-5 gap-1 lg:gap-2 p-2 lg:p-4
...
pub fn CharacterPortrait() -> impl IntoView {
    ...
    view! {
        <div class="flex items-center justify-center h-full w-full relative overflow-hidden">
            ...
            <div class="border-6 lg:border-8 border-double border-stone-500 h-full w-full">
                <div
                    class="h-full w-full"
                    style=format!(
...
fn GrindingAreaCard(area: UserGrindArea) -> impl IntoView {
    ...
    view! {
        <div
            ...
            on:click=play_area
        >
            <div class="h-10 lg:h-16 w-full relative">
                <img
            ...
            <div class="p-2 lg:p-4 space-y-1 lg:space-y-2">
                <div class="text-base lg:text-lg font-semibold text-amber-200">
